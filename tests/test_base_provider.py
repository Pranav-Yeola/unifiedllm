...
class ConcreteTestProvider(BaseProvider):
    ...
    def config(
        self, *, temperature=None, top_p=None, max_tokens=None, stop=None, custom=None
    ):
...
class TestBaseProviderInitialization:
    ...
    def test_valid_api_key_succeeds(self):
        ...
        provider = ConcreteTestProvider(
            model="test-model", api_key="valid-key", timeout=30.0
        )
    ...
    def test_loads_api_key_from_env(self, monkeypatch):
        ...
        provider = ConcreteTestProvider(
            model="test-model", api_key="default", timeout=30.0
        )
...
class TestBaseProviderParseErrors:
    ...
    def test_invalid_json_raises_provider_parse_error(
        self, monkeypatch, fake_httpx_response
    ):
    ...
    def test_missing_required_field_raises_provider_parse_error(
        self, mock_http_success
    ):
...
class TestBaseProviderImplementation:
    ...
    def test_missing_class_attributes_raises_error(self):
        ...
        class IncompleteProvider(BaseProvider):
            ...
            def _extract_error_details(self, resp):
                pass
            ...
            def _extract_request_id(self, resp):
                pass
