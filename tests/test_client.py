...
class TestLLMConfigurationMethods:
    ...
    def test_system_prompt_returns_self_for_chaining(self, monkeypatch):
        ...
        assert result is llm
        mock_provider.system_prompt.assert_called_once_with("You are a helpful assistant")
    ...
    def test_method_chaining_works(self, monkeypatch):
        ...
        response = llm.config(temperature=0.5).system_prompt("Be helpful").chat(prompt="Hello")
