...
class TestHTTPClientStatusError:
    ...
    def test_status_400_raises_http_status_error(self, fake_httpx_response, monkeypatch):
    ...
    def test_status_401_raises_http_status_error(self, fake_httpx_response, monkeypatch):
    ...
    def test_status_500_raises_http_status_error(self, fake_httpx_response, monkeypatch):
